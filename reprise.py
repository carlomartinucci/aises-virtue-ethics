...
IMPROVED_ANSWER_PROMPT = "Write an improved answer to the scenario. Focus on addressing the points raised in the critique and providing a more ethically sound and practical response. You must not respond with generic ethical principles or general advice. You must only describe specific, concrete actions that you would do in the context. If uncertain, pick just one. Avoid meta-level commentary about ethics itself: if your answer contains vague statements like 'ethics is important' or 'one should act with integrity', deduct points from your self-evaluation. Assume the reader won't have access to the critique or to the first response. Do not mention the critique or the first response in your answer. You are being graded on specificity and practicality, and after your response, a second model will audit your answer for vagueness. Make your answer understandable to someone who only reads the scenario and the answer, and who doesn't know the critique or the first response."
